 ...
 * $Id: 7cbf4200877f62d286a83210d19677cd2099dcfd $
 *
...
stream_t *stream_AccessNew( access_t *p_access, char **ppsz_list )
{
    ...
    s->pf_read    = (int (*)(stream_t *, void *, unsigned int))AStreamGenericError;    /* Replaced later */
    s->pf_peek    = &AStreamGenericError;
    s->pf_readdir = (input_item_t *(*)(stream_t *))AStreamGenericError;
